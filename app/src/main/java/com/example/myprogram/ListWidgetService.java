...
public class ListWidgetService extends RemoteViewsService {
    ...
    class ListRemoteViewsFactory implements RemoteViewsFactory, StateAdapter.OnClickToMore{

        private static final int mCount = 10;
        private List<StateAdapter> mWidgetItems = new ArrayList<StateAdapter>();
        ...
        public void onCreate() {
            ...
            recyclerViewNotes = recyclerViewNotes.findViewById(R.id.rv);
            // In onCreate() you setup any connections / cursors to your data source. Heavy lifting,
            // for example downloading or creating content etc, should be deferred to onDataSetChanged()
            // or getViewAt(). Taking more than 20 seconds in this call will result in an ANR.
            for (int i = 1; i <= mCount; i++) {
//                mWidgetItems.add(new StateAdapter("Item" + i));
            }
        ...
        public RemoteViews getViewAt(int position) {
            ...
            RemoteViews dv = new RemoteViews(mContext.getPackageName(),R.layout.list_item);
            dv.setTextViewText(R.id.emptyfav, mWidgetItems.get(position).text);
            ...
            dv.setOnClickFillInIntent(R.id.emptyfav, fillInIntent);
